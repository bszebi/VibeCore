...
// Ellenőrizzük, hogy a felhasználó jogosult-e az eszköz módosítására
...
// Eszköz megjelölése bepakoltként
$update_query = "UPDATE work_to_stuffs SET 
                    is_packed = 1,
                    packed_date = CURRENT_TIMESTAMP,
                    packed_by = ?
                WHERE work_id = ? AND stuffs_id = ?";

$stmt = mysqli_prepare($conn, $update_query);
mysqli_stmt_bind_param($stmt, "iii", $_SESSION['user_id'], $work_id, $stuff_id);
...
if (mysqli_stmt_execute($stmt)) {
    ...
    echo json_encode(['success' => false, 'message' => 'Hiba történt a bepakolás rögzítése során']);
}
?> 